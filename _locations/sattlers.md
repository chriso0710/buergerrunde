...
category: Bauernhöfe
description: Lokaler Bauernhof / Hofanwesen in Heuweiler, im Ort oft 'Sattler's'
  genannt (offiziell Seilerhof / Sailerhof).
address: Dorfstraße 2, Heuweiler, Baden-Württemberg
latitude: 48.0495
longitude: 7.901034
website: ""
image: ""
...
notes: "‚Sattlers‘ ist im Ortals Bezeichnung für das Anwesen Seilerhof /
  Sailerhof; es konnten keine eindeutige offizielle Postadresse oder ein
  verifizierbarer Direktlink zu einem Bild speziell für ‚Sattlers‘ gefunden
  werden. Koordinaten entsprechen dem Gemeindemittelpunkt von Heuweiler
  (Wikipedia). Quellen: Gemeindewebseite, Wikipedia, lokale Ortsbeschreibung
